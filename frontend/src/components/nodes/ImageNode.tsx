      ...
      {content ? (
        <div className="w-full h-full relative pointer-events-none">
          ...
          <div
            ...
            } transition-opacity flex items-center justify-center text-white text-xs rounded font-medium pointer-events-none`}
          >
            📷 Double-click to Change Image
          </div>
        </div>
      ) : (
        <div className="w-full h-full flex flex-col items-center justify-center bg-gray-50 border-2 border-dashed border-gray-300 rounded text-gray-400 text-sm select-none p-2 pointer-events-none">
